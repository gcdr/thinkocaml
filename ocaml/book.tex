% LaTeX source for ``Think OCaml: How to Think Like a Computer Scientist''
% Copyright (c)  2011  Nicolas Monje
...
For this exercise, we need a list of English words.
There are lots of word lists available on the Web, but the one most
suitable for our purpose is one of the word lists collected and
contributed to the public domain by Grady Ward as part of the Moby
lexicon project\footnote{\url{wikipedia.org/wiki/Moby_Project}.}.  It
is a list of 113,809 official crosswords; that is, words that are
considered valid in crossword puzzles and other word games.  In the
Moby collection, the filename is {\tt 113809of.fic}; I host a copy
of this file, with the simpler name {\tt words.txt}, at {\url www.thinkocaml.com/bin/words.txt}.
...
\index{parameter!labelled}
\index{labelled parameter}
...
\index{hashtbale!subtraction}
\index{subtraction!hashtable}
...
\afterverb
%
% Here are some of the results from {\em The Adventures of Sherlock Holmes}:
% %DO THIS
% \beforeverb
% \begin{verbatim}
% Sike!
...
% \index{type!set}
% %Look this up!
% OCaml provides a data structure called {\tt set} that provides many
...
% there are tools, that can identify %find one!
...
% \begin{itemize}
% 
% \item Syntax errors are produced by OCaml when it is translating the
...
% problem occurred.  Actually, it tells you where OCaml
...
% \begin{enumerate}
% 
% \item Make sure you are not using a OCaml keyword for a variable name.
% 
% \index{keyword}
% 
...
%   \verb+[+---makes OCaml continue with the next line as part of the
